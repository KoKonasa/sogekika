...
public class Timer_1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //GameObject objc = GameObject.Find("Canvas");
        //UIController = objc.GetComponent<UIController>();
    }
    ...
    void Update()
    {
        ...
        if (totalTime <= 0f)
        {
            ...
            Time.timeScale = 0f;
            if (UIController.score > GameManager.instance.bestscore1)
            {
                GameManager.instance.bestscore1 = UIController.score;
